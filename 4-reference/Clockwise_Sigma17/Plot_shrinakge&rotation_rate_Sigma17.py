...
t_dimension = (np.sqrt(17)/17*3.62e-10)**2/(4.957e-8)/1e-9 #1.829*1e-4

#MD_data_rotation
T_29 = np.loadtxt('sigma17-28-MD.txt', delimiter=',',usecols=0)
W_29 = np.loadtxt('sigma17-28-MD.txt', delimiter=',',usecols=1)
...
#MD_data_shrinkage
TT_29 = np.loadtxt('sigma17-a.txt', delimiter=',',usecols=0)
A_29 = np.loadtxt('sigma17-a.txt', delimiter=',',usecols=1)
A_29 = A_29/A_29[0]
